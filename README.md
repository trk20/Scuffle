...
2. Afterwards, your score is counted and added to your total for that turn. 
Then you draw as many new letters as you played; 
There are always seven letters in your hand, as long as there are enough tiles left in the bag.
...
plus the additional points obtained from placing letters on _Premium Squares_.
3. PremiumLetter Squares: 
...
(with their full premium value if any).
7. The player with the highest final score wins the game. 
